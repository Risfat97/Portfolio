...
<xsl:stylesheet  version="1.0"
    ...
    <html lang="fr" dir="ltr">
        <head>
            ...
            <title>Portfolio Tafsir Mbodj NDIOUR: expériences</title>
        ...
        <body>
            <main about="#tafsir" typeof="foaf:Person">
                <aside>
                    ...
                    <a href="/experiences" class="aside-link active" property="rdfs:seeAlso" resource="/experiences">
                    ...
                    <xsl:for-each select="experiences/experience">
                        <article class="exp-container">
                            ...
                            <div class="body">
                                ...
                                <xsl:if test="tools">
                                    <p class="exp-tools-header text-gray">Frameworks / Langages de programmation</p>
                                    <ul>
